...
install_chart() {
    ...
    # Build and apply Weft CRDs first (they are generated by Bazel, not in the chart directly)
    log_info "Building and applying Weft CRDs..."
    bazel build //api/v1alpha1:generated.crds
    kubectl apply -f bazel-bin/api/v1alpha1/crd.yaml
    
    # Build and apply RBAC Role (generated by Bazel)
    log_info "Building and applying RBAC Role..."
    bazel build //api/v1alpha1:generated.rbac
    kubectl apply -f bazel-bin/api/v1alpha1/role.yaml
